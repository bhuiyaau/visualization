...
This is a visualization of Belgium's trade balance. While the colours make it visually appealing with the coloured ribbons and decorative background, the actual substance is lacking. It is difficult to understand what message they are trying to convey, what the purpose of the visualization is (e.g., is it for evaluation or exploration?), who the intended audience is, and high cognitive load to interpret this information (e.g., high extraneous, lack of germane or familiarity). While it is two-dimensional, it does not have a clean layout or inclusion of data sources at the bottom of the image. Further, the label density makes it difficult to scan and the line thickness appears to have meaning, but it is not described. The visual hierarchy is muddled in the sense that everything is competing for our attention. Related to Gestalt principles (mentioned in brackets in the following section), the related items are not grouped to make it easy to scan (e.g., proximity), too many colours (e.g., similarity), the busy background and dense flow paths compete with the data (e.g., figure-ground), overall structure does not convey a clear story (e.g., closure), it is complex (e.g., simplicity), and few boundaries (e.g., enclosure)
      ```
...
Bad: https://www.behance.net/gallery/21974687/Belgian-trade-balance
It needs to reduce the number of flows and labels, have a clean legend so that the viewer can see the source, steps, and outcomes. They should have also kepted a limited meaningful colour palette, and ensure that the thickness of the lines have meaning or value. They could have removed the background to make it easier to read (e.g., add more white space), increase the font size, and simplify the typography. In terms of interpretation, it would have been helpful to add a clear title, subtitles, units, time period, and net balance summaries. A simpler bar chart or line chart could have linked communicated this better.
